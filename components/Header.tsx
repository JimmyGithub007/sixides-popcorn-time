...
const Header = (props: Props) => {
    ...
    return (<header className={`${scrollY > 0 ? "bg-white pr-12" : "bg-black shadow-2xl pl-12 text-yellow-300"} h-16 flex flex-row items-center rounded-md font-bold gap-2 sticky top-0 z-20 duration-300`}>
